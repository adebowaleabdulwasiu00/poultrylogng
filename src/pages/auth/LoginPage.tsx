      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-logo">
            ...
            <h1>PoultryLog NG</h1>
            <p className="auth-subtitle">Smart Farm Management System</p>
          </div>

          <div className="auth-welcome">
            <h2>Welcome</h2>
            <p>Sign in to manage your poultry farm operations, track production, and monitor performance — all in one place.</p>
          </div>
